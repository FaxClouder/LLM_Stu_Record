...
学习目标：评估召回质量，并在必要时改写或切换信息源。
阅读重点：外部搜索应具有来源过滤、超时和失败回退。
...
from rag_techniques_zh.upstream_helpers import encode_pdf
import json
...
class CRAG:
    ...
    def __init__(self, path, model=CHAT_MODEL, max_tokens=1000, temperature=0, lower_threshold=0.3,
                 upper_threshold=0.7):
        """
